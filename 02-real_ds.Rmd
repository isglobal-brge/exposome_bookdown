...
A couple remarks regarding this files:
...
+ The exposure names have to start with a character [a-z/A-Z], trailing special characters will cause the data entry to return errors.
