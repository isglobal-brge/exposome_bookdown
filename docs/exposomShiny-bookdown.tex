...
Once the project is loaded, run the following code to install \texttt{renv} if it's not present on your R packages library and load the dependencies of exposomeShiny on this R session.
